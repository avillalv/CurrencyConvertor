...
"""
#I WILL IMPORT DEQUE FOR EASIER QUEUE CONTROL, JSON, AND MY CLASS MODULE
from collections import deque
import json
from currencyClass import Currency, FiatCurrency, CryptoCurrency
...
while True:
    ...
    if exit_choice == "C" or exit_choice == "c":
                ...
                try:
                    ...
                    if choice==3:
                        ...
                        try:
                            ...
                            #IF THE NAME IS FOUND, IT PRINTS THE ADMIN INFO
                            if admin_name in history:
                                admin_info=history[admin_name]
                                print(f"Information for {admin_name}: ")
                                print(admin_info)
                                break
                            #IF THE NAME IS NOT FOUND, ERROR IS PRINTED AND BREAKS LOOP - GOES TO MAIN MENU OPTION
                            else:
        ...
        #ENDING OF ADMIN SECTION
            #THIS IF SECTION WILL WRITE ADMIN HISOTRY INTO NEW JSON FILE
        ...
        # If user is a normal user, it will create them a menu selection to start the currency conversion
            ...
            #THIS IF BLOCK WILL ASSIGN WHAT ROLE THE USER HAS; EITHER USER OR ADMIN
            if len(user_stack) > 0:
                user_stack.reverse()
                user_dict = {}
                ...
                # THIS LOOP WILL LOOP THROUGH WITH THE LENGTH OF THE STACK WITHOUT THE NAME AS THE CONDITION
                # WILL ADD EACH VALUE FROM THE STACK TO THE USER_HISTORY DICT
                i = 1
                ...
                #WRITES THE USER_HISTORY DICTIONARY TO THE JSON FILE
                file_path = "convertor_history.json"
                with open(file_path, "w") as json_file:
                    json.dump(user_history, json_file, indent=4)


    #MAIN PROGRAM EXITS WHEN USER PICKS "E" IN INITIAL INPUT
